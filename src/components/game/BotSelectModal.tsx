      ...
      {open ? (
        <>
          ...
          <motion.div
            ...
            className="fixed bottom-0 left-0 right-0 z-[70] flex max-h-[min(88dvh,820px)] flex-col rounded-t-[1.35rem] border border-white/10 bg-[#0f1419] text-slate-100 shadow-[0_-8px_48px_rgba(0,0,0,0.45)]"
            style={{
          ...
          >
            <div className="flex shrink-0 flex-col items-center pt-3 pb-2">
              ...
              <p className="mt-1 px-5 text-left text-xs text-slate-400">
              ...
              {ALL_BOT_TIERS.map((tier) => (
                <section key={tier.id} className="mb-6 last:mb-2">
                  <div className="mb-2 flex items-baseline justify-between gap-2">
                    <h3 className="text-sm font-bold tracking-wide text-cyan-200/90">
                      {tier.label}
                    </h3>
                    ...
                    {tier.bots.map((bot) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <span className="mt-1.5 line-clamp-2 text-[11px] font-semibold leading-tight text-slate-100">
                            {bot.name}
                          </span>
                        </button>
                      );
